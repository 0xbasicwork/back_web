  ...
  return (
    <footer className="w-full bg-black py-6 mt-16">
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-4">
        ...
        <div className="text-white text-[14px] text-center" style={{ fontFamily: 'var(--font-roboto-mono)' }}>
          <p className="mb-2">
